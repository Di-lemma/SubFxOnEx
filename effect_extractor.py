...
CONTROLLED_EFFECT_ONTOLOGY = {
    "visual": {
        ...
        # Objects, surfaces, faces, text, or parts of the visual field appear
        # bent, curved, stretched, twisted, or otherwise deformed.
        "morphing": "visual distortions",
        # Objects, faces, patterns, or visual forms appear to transform
        # continuously into other shapes, identities, structures, or forms.
        "drifting": "visual distortions",
        # Stationary objects, patterns, surfaces, or parts of the visual field
        # appear to slide, float, sway, or slowly move.
        "shimmering": "visual distortions",
        # Surfaces, edges, textures, light, or the visual field appear to
        # flicker, glint, ripple, or show an unsteady luminous instability.
        "visual vibration": "visual distortions",
        # Objects, edges, patterns, or the visual field appear to tremble,
        # oscillate, buzz, or rapidly quiver in place.
        "fractal imagery": "visual distortions",
        # Self-similar, recursively repeating forms appear at multiple scales,
        # often branching or unfolding into increasingly detailed patterns.
        "geometric imagery": "visual distortions",
        # Grids, lattices, tessellations, mandala-like forms, angular
        # structures, or other abstract geometric patterns appear.
        "visual imagery": "visual distortions",
        # Internally generated visual content experienced as image-like, whether
        # the eyes are open or closed. Eye state and content belong in detail.
        "simple visual hallucination": "visual distortions",
        # Unformed light, color, flashes, points, or elementary shapes without
        # an ordinary external source.
        "complex visual hallucination": "visual distortions",
        # Fully formed objects, figures, entities, or scenes without an ordinary
        # external source. Content belongs in detail.
        ...
        # Objects, body parts, people, or environmental features appear
        # unusually enlarged, reduced, inflated, or shrunken.
        "distance distortion": "visual distortions",
        # Objects, people, or parts of the environment appear closer, farther
        # away, or shifted in distance relative to their expected position.
        "depth distortion": "visual distortions",
        # Spatial depth changes, with scenes or objects appearing flattened,
        # layered, recessed, expanded, or otherwise altered in structure.
        "foreshortening distortion": "visual distortions",
        # Body parts, objects, or spatial forms appear unnaturally compressed,
        # elongated, or altered along the line of view.
        "perspective distortion": "visual distortions",
        # A scene's geometric relations change: angles, proportions,
        # orientation, or lines of sight appear warped, skewed, or tilted.
        "scene replacement": "visual distortions",
        # Part or all of the visual scene appears replaced by a different place,
        # setting, or constructed environment.
        "environmental transfiguration": "visual distortions",
        # The environment appears transformed in character, style, material,
        ...
        # One object or image appears as two or more simultaneous copies. The
        # number and binocular/monocular context belong in detail.
        ...
        # Moving objects are seen as discrete jumps, freeze-frames, or missing
        # intervals rather than continuous motion.
        ...
        # The visual field, an image, or a scene appears nested or repeated
        # within itself, without requiring fractal geometry.
        "textual instability": "visual distortions",
        # Letters, words, or lines of text appear to move, rearrange, detach, or
        # lose stable visual organization despite remaining visually legible.
    },
    "auditory": {
        ...
        # Sound-like content is experienced internally and recognized as
        # imagery rather than as an event in external auditory space.
        "auditory hallucination": "auditory distortions",
        # A voice, tone, music, noise, or other sound is heard without an
        # ordinary external source. Content belongs in detail.
        ...
        # Ambiguous real sound is heard as a voice, music, words, or another
        # organized auditory object.
    },
    "olfactory": {
        ...
        # Perceiving smells with no external source, such as smoke, burning,
        # chemical, floral, or decay.
        "olfactory distortion": "olfactory change",
        # Familiar smells perceived as altered or wrong.
    },
    "gustatory": {
        ...
        # Taste with no source, often a persistent metallic, chemical, or bitter taste.
        "taste distortion": "gustatory change",
    },
    "synesthetic": {
        "synesthetic change": "synesthetic change",
        "synesthesia": "synesthetic change",
        # A stimulus or concept in one modality/category automatically evokes a
        # concurrent experience in another. Inducer and concurrent go in detail.
    },
    "vestibular": {
        ...
        # Non-spinning translation, rocking, swaying, or movement of the self
        # despite physical stillness. Rotational self/world motion is vertigo.
    ...
    "interoceptive": {
        ...
        # Internal organs or bodily interiors feel displaced, reshaped, empty,
        # enlarged, or otherwise configured differently.
    ...
    "somatic": {
        ...
        # A directly felt pleasant bodily sensation, distinct from positive mood.
        "palpitations": "body load",
        # A heartbeat feels unusually forceful, fast, irregular, or pounding.
        "dyspnea": "body load",
        # Subjective breathing difficulty or air hunger, not mere attention to breathing.
        "malaise": "body load",
        # Diffuse bodily unwellness or sickliness without a narrower symptom.
        "thirst": "body load",
    ...
    "emotional": {
        ...
        # Felt emotion conflicts with its expression, the situation, or another
        # simultaneously experienced affect; this is not rapid mood change.
    ...
    "cognitive": {
        ...
        # Thoughts feel crowded, excessive, or forcefully numerous; racing
        # thoughts concern speed rather than crowding.
        "thought slowing": "cognitive change",
        "thought looping": "cognitive change",
        "thought interference": "cognitive change",
        # Irrelevant thoughts intrude into and disrupt the current line of
        # thinking without necessarily being unwanted or repetitive.
        ...
        # Attention becomes fully engrossed while peripheral, self, or time
        # awareness recedes; ordinary concentration alone is increased focus.
        ...
        # The mind is experienced as divided into conflicting parts, streams, or
        # modes of thought: “it felt like two parts of my mind were fighting.”
        "meta-awareness of irrationality": "cognitive change",
        # Awareness that a thought, fear, or belief is irrational while it is
        # still experienced: “part of me knew it was nonsense.”
        "double bookkeeping": "cognitive change",
        # Incompatible ordinary and altered reality-frameworks are maintained
        # simultaneously, rather than one merely being recognized as irrational.
        ...
        # Thoughts feel not-mine or alien without a claim that another agent put
        # them there; externally implanted thoughts are thought insertion.
        "thought insertion": "cognitive change",
        "thought broadcasting": "cognitive change",
        "thought echo": "cognitive change",
        # A just-occurring thought is experienced as repeated or heard, rather
        # than the same train of thought recurring as in thought looping.
        "inner speech externalization": "cognitive change",
        # Inner speech acquires voice-like sensory qualities or an apparent
        # location while still being recognized as one's own inner speech.
        ...
        # A thought gradually weakens or slips away, unlike the abrupt stop of
        # thought blocking or the empty state of mind blanking.
        ...
        # Thoughts are experienced as passing mental events rather than as the
        # self or literal facts; this does not imply detachment from the body.
        "hyperreflexivity": "cognitive change",
        # Normally tacit mental or perceptual processes become explicit objects
        # of sustained awareness.
        ...
        # Ordinary events or the surrounding world feel baffling and difficult
        # to make sense of despite preserved basic orientation.
        "psychological insight": "cognitive change",
        # A concrete realization about one's own emotions, patterns, motives, or
        # behavior, distinct from cosmic or externally revealed truth.
        "volitional control impairment": "cognitive change",
        # Difficulty intentionally initiating, directing, or stopping thought or
        # action, without requiring paralysis or motor incoordination.
        "emotion identification difficulty": "cognitive change",
        # Emotion is present but difficult to identify or name; emotional
        # blunting instead concerns reduced affect.
        "dreamlike cognition": "cognitive change",
        # Waking thought follows dreamlike logic or associations without
        # requiring visual imagery or the belief that the world is unreal.
    ...
    "temporal": {
        ...
        # Time feels frozen or halted while experience continues; timelessness
        # is an absence or transcendence of temporal structure.
        "temporal simultaneity": "time distortion",
        # Past, present, future, or multiple moments feel co-present.
        "temporal ordering disruption": "time distortion",
        # Events are experienced out of sequence despite being individually
        # remembered; fragmentation concerns gaps or discontinuous flow.
    },
    "spatial": {
        "spatial change": "spatial change",
        "spatial scale distortion": "spatial change",
        # Experiential space itself feels expanded or contracted, distinct from
        # an individual object's apparent visual size or distance.
        "spatial boundlessness": "spatial change",
        # Space feels unlimited or without reachable edges.
        "spacelessness": "spatial change",
        # Ordinary spatial extension or location seems absent altogether.
        "perspectival dislocation": "spatial change",
        # Experience seems located at no single viewpoint, everywhere at once,
        # or from an indeterminate viewpoint without leaving the body.
    },
    "world-experience": {
        "world-experience change": "world-experience change",
        "uncanniness": "world-experience change",
        # The recognizable world feels eerily strange or alien without
        # necessarily seeming unreal, dangerous, or unfamiliar.
        "atmospheric portent": "world-experience change",
        # The surrounding world feels charged with an unspecified imminent
        # event, revelation, or significance without a formed belief about it.
        "environmental vitality loss": "world-experience change",
        # Surroundings feel lifeless, inert, drained, or devoid of ordinary
        # vitality without requiring visual dimming or emotional numbness.
        "perceptual meaning loss": "world-experience change",
        # Objects or situations are perceived and recognized but their ordinary
        # purpose, relevance, or lived meaning no longer arrives.
        "perceptual freshness": "world-experience change",
        # Familiar, recognized things feel newly encountered or freshly seen;
        # unlike jamais vu, their familiarity and identity remain available.
        "hyperfamiliarity": "world-experience change",
        # A person, place, object, or situation feels deeply familiar beyond
        # recognition or prior acquaintance, without a sense of event repetition.
    },
    "selfhood": {
        ...
        # The experienced self becomes unusually enlarged, powerful, important,
        # or expansive; this is not merely confidence or felt action control.
        ...
        # Actions or intentions no longer feel authored or controlled by oneself,
        # without asserting that an external agent controls them.
        "action automaticity": "selfhood change",
        # One's body performs actions without conscious initiation while the
        # actions are still experienced as one's own bodily actions.
        "external control experience": "selfhood change",
        # Actions, impulses, or feelings seem controlled by an outside agent or force.
        "affect ownership loss": "selfhood change",
        # An emotion is experienced as present but not as one's own.
        ...
        # One sees a double of one's body while self-location remains in the
        # physical body.
        "heautoscopy": "selfhood change",
        # One sees a bodily double and self-location or self-identification is
        # ambiguous or alternates between body and double.
        ...
        # The self feels tiny or insignificant relative to something vast; this
        # is not a visual change in body size or a moral stance of humility.
        "diminished self-presence": "selfhood change",
        # One feels absent, not fully alive, or only weakly present as a subject,
        # without necessarily feeling detached from body or surroundings.
    ...
    "spiritual": {
        ...
        # People, objects, places, or the experience itself feel holy, reverent,
        # or spiritually significant.
        "revelatory insight": "spiritual experience",
        # A sudden or powerful insight feels like a revealed truth, message, or
        # realization about reality, life, or oneself.
        "existential insight": "spiritual experience",
        # Realization or reflection concerns meaning, identity, mortality,
        # purpose, or another fundamental aspect of existence.
        "cosmic significance": "spiritual experience",
        # Events, thoughts, or perceptions feel universally important or
        # connected to a larger cosmic order or purpose.
        "sensed presence": "spiritual experience",
        # A distinct other being or agent feels present without ordinary sensory
        # evidence; content or identity belongs in detail.
        ...
        # The experience itself feels impossible to express adequately, rather
        # than the reporter merely lacking a word or forgetting a detail.
        "pure awareness": "spiritual experience",
        # Awareness is experienced without ordinary thought, image, object, or
        # autobiographical content; this is not mind blanking or sedation.
        "coincident opposites": "spiritual experience",
        # Apparently incompatible qualities or opposites feel simultaneously
        # true or reconciled within the experience.
    ...
    "social": {
        ...
        # Felt equality, shared humanity, and collective togetherness with a
        # group, beyond connection to a particular individual.
    ...
    "tactile": {
        ...
        # Touch is felt at a different bodily location from its actual source.
        "tactile recognition impairment": "tactile change",
        # Touch is detected but texture, shape, or material cannot be identified.
